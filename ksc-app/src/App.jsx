...
import {
  ...
  LogOut, KeyRound, ShieldCheck, Lock, User as UserIcon
} from "lucide-react";
import {
  ...
  return (
    <div className="app-root">
      ...
      <aside className="sidebar">
        ...
        <nav>
          {navVisible.map((n) => (
            <NavItem key={n.key} icon={<n.icon size={17} />} label={n.label} active={viewPermitida === n.key} onClick={() => setView(n.key)} />
          ))}
        </nav>
...
const GLOBAL_CSS = `
  * { box-sizing: border-box; }
  ...
  .panel{ background:#FBF9F4; border:1px solid #E5DDCE; }
  .panel + .panel{ margin-top:18px; }
  table{ width:100%; border-collapse:collapse; font-size:13.5px; }
  th{ text-align:left; font-weight:600; color:#8A7F6E; font-size:12px; padding:10px 14px; border-bottom:1px solid #E9E1D3; }
  ...
  .tab-switch{ display:flex; gap:4px; margin-bottom:18px; border-bottom:1px solid #E5DDCE; }
  .tab-btn{ background:none; border:none; padding:10px 4px; margin-right:22px; font-family:'IBM Plex Sans',sans-serif; font-size:13.5px; font-weight:600; color:#A89D8C; cursor:pointer; border-bottom:2px solid transparent; position:relative; top:1px; }
...
function AgendaView({ turnos, setTurnos, pacientes, setPacientes, pacienteById }) {
  ...
  return (
    <div>
      ...
      <div className="panel" style={{ padding: "14px 18px", display: "flex", alignItems: "center", gap: 14, marginBottom: 18 }}>
